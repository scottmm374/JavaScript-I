...
const findThirtyThree = inventory.find(item => item.id === 33);
console.log(findThirtyThree.car_year, findThirtyThree.car_make, findThirtyThree.car_model);
...
const modelsSorted = inventory.sort(function (a, b) {
...
console.log(findOld(carYears));

// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
let BMWAndAudi = [];

const findCars = inventory.find(car => car.car_make === "BMW" || car.car_make === "Audi"){

    BMWAndAudi.push(inventory.car_make);
};
